...
int main(int argc,const char *argv[])
{
        ...
        else
        {
            ...
            do{
                char bufor[100];
                if(fgets(bufor,100,input_file)==NULL)
                {
                    ...
                    int letters=0,first_semicolon=0,second_semicolon=0,commas=0;
                    for(j=0;j<strlen(bufor);j++)
                    {
                        if(bufor[j]== ';' && first_semicolon == 0)
                            {
                            first_semicolon = j;
                            }
                        if(bufor[j]== ';' && first_semicolon !=0)
                ...
                if(first_semicolon == 0 || second_semicolon == 0)
                {
                    continue;
                }

                strncpy(author,bufor,first_semicolon);
                author
